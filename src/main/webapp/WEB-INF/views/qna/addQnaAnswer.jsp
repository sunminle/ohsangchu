...
<body>
	<c:if test="${qnaReplyCheck == 0}">
	<center>
		<h2 class="page-header">QnA 답변작성</h2>
		<form id="addQnaAnswer" action="/qna/addQnaAnswerPro" method="post">
	...
	<script>
		alert("이미 답변을 등록하셨습니다.");
	 	location.href = "<c:url value='/qna/qnaList'/>"; // 공지메인페이지로
	</script>
	</c:if>
